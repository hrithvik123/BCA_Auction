...
urlpatterns = [
    ...
    path('team/<str:pk>/', auction_views.TeamDetailView.as_view(), name='team-detail'),
    path('team/<str:pk>/edit',
         auction_views.updateTeamView.as_view(), name='team-edit'),
    #     path('team/list',
    ...
    path('players/new', auction_views.PlayerCreateView.as_view(),
         name='player-new'),
    path('player/<str:pk>/',
         auction_views.PlayerUpdateView.as_view(), name='player-edit'),
